...
/// The tooltip leader's cells: two-space pad, then the corner and its space — the width the
/// render's wrap subtracts.
...
/// The house empty state's frame rows: the hint line and the frame's own two borders.
